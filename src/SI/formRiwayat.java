...
public class formRiwayat extends javax.swing.JFrame {
    ...
    private void cari() {
        try {
            ...
            rs = st.executeQuery("SELECT * FROM history_gaji WHERE Bulan LIKE '%"+ cmbBulan.getSelectedItem().toString() +"%'");
...
//        tabelGaji.getColumnModel().getColumn(0).setPreferredWidth(18);
        ...
        tabelRiwayat.getColumnModel().getColumn(2).setPreferredWidth(55);
        tabelRiwayat.getColumnModel().getColumn(3).setPreferredWidth(30);
        tabelRiwayat.getColumnModel().getColumn(4).setPreferredWidth(70);
        tabelRiwayat.getColumnModel().getColumn(5).setPreferredWidth(60);
        tabelRiwayat.getColumnModel().getColumn(6).setPreferredWidth(40);
    }
    /**
    ...
    private void initComponents() {
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/time (2).png"))); // NOI18N

        jLabel8.setBackground(new java.awt.Color(255, 255, 255));
        jLabel8.setFont(new java.awt.Font("Bahnschrift", 1, 42)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("RIWAYAT PENGGAJIAN");
        ...
        tabelRiwayat.setFont(new java.awt.Font("Bahnschrift", 0, 11)); // NOI18N
        tabelRiwayat.setForeground(new java.awt.Color(75, 86, 210));
        tabelRiwayat.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nama", "Bulan", "Masuk", "Terima Gaji", "Total Gaji", "Time Stamp"
            }
        ) {
        ...
        tabelRiwayat.setGridColor(new java.awt.Color(255, 255, 255));
    ...
    private void cetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cetakActionPerformed
        try {
            String delete = ("DELETE FROM cetak_history");
            st.executeUpdate(delete);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e);
        }
        DefaultTableModel mdl = (DefaultTableModel) tabelRiwayat.getModel();
        if (mdl.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null,"Tabel Kosong !");
        } else {
            String Id,Nama,Bulan,Masuk,Ambil,Total,Tanggal;
            try {
                for (int i=0; i<mdl.getRowCount(); i++) {
                    ...
                    Tanggal = mdl.getValueAt(i, 6).toString();
                    
                    String sql = "INSERT INTO cetak_history (Id,nama,Bulan,masuk,ambil_gaji,total_gaji,tanggal) VALUES (?, ?, ?, ?, ?, ?, ?)";
                ...
                String file ="src/report/riwayatGaji.jasper";
